...
var chartjs__namespace = /*#__PURE__*/_interopNamespaceDefault(chartjs);
...
const CChart = vue.defineComponent({
    ...
    setup(props, { expose, emit, slots }) {
        ...
        const computedData = vue.computed(() => typeof props.data === 'function'
            ? canvasRef.value
        ...
        const renderChart = () => {
            ...
            if (props.customTooltips) {
                ...
                chartjs__namespace.defaults.plugins.tooltip.external = customTooltips;
            }
...
const CChartBar = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'bar' });
    },
});
const CChartBubble = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'bubble' });
    },
});
const CChartDoughnut = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'doughnut' });
    },
});
const CChartLine = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'line' });
    },
});
const CChartPie = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'pie' });
    },
});
const CChartPolarArea = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'polarArea' });
    },
});
const CChartRadar = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'radar' });
    },
});
const CChartScatter = vue.defineComponent({
    ...
    extends: CChart,
    setup(props) {
        return () => vue.h(CChart, { ...props, type: 'scatter' });
    },
});
const CChartPlugin = {
    install: (app) => {
